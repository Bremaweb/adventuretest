...
HUD_AIR_POS = {x=0.5,y=0.865}
HUD_AIR_OFFSET = {x=15,y=-15}
HUD_ARMOR_POS = {x=0.5,y=0.865}
...
-- fancy hotbar (only when no crafting mod present)
 ...
 player:hud_add({
 	...
 	scale = {x=1,y=1},
 	text = "hud_stamina_bg.png",
 	number = 20,
 	alignment = { x=-1, y=-1 },
 	offset = {x=-175, y=-15},
 })
 
 stamina_hud[name] = player:hud_add({
 	hud_elem_type = "statbar",
 	position = {x=0.5,y=0.9},
 	scale = {x=1,y=1},
 	text = "hud_stamina_fg.png",
 	number = 0,
 	alignment = { x=-1, y=-1 },
 	offset = {x=-175, y=-15},
 })
 ...
 player:hud_add({
 	...
 	position = {x=0.5,y=0.9},
 	scale = {x=1,y=1},
 	text = "hud_magic_bg.png",
 	number = 20,
 	alignment = { x=-1, y=-1 },
 	offset = {x=15, y=-15},
 })
 
 magic_hud[name] = player:hud_add({
 	hud_elem_type = "statbar",
 	position = {x=0.5,y=0.9},
 	scale = {x=1,y=1},
...
--stamina
	local s = tonumber(player_stamina[name])
